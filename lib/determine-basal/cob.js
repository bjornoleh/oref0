    ...
    for (i=0; i < bucketed_data.length-3; ++i) {
        ...
        if(bgTime > mealTime) {
            ...
            if (profile.use_Static_COB_decay == true) {
                ...
                console.error("use_Static_COB_decay =",profile.use_Static_COB_decay,", cobDecayAdjust:", profile.cobDecayAdjust);
                } else {
                    var absorbed = ci * profile.carb_ratio / sens ;
                    console.error("use_Static_COB_decay =",profile.use_Static_COB_decay);
            }
