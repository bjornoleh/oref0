...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    if ( sens_modified ) {
        ...
        isfreason += ", autoISF, Duration: " + dura05 + ", Avg: " + convert_bg(avg05,profile) + ", Ratio: " + round(liftISF,2) + ", ISF: " + convert_bg(sens,profile) +  calcreason;
    }
...
// Adjust ISF based on sensitivityRatio
    ...
    if (typeof autosens_data !== 'undefined' && autosens_data) {
        ...
        //process.stderr.write(" (autosens ratio "+sensitivityRatio+")");
        isfreason += "Autosense, Ratio: " + sensitivityRatio + ", ISF: " + convert_bg(profile_sens,profile) + "\u2192" + convert_bg(sens,profile) + isfadaptionreason;
